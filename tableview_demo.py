...
if __name__ == '__main__':
    global tv
    #v = ui.load_view()
    v = ui.View(frame=(0, 0, 240, 240), flex='WH')
    TV = ui.TableView(frame=(0, 0, 240, 196), name='tv_1', flex='WH')
    B1 = ui.Button(frame=(6, 202, 80, 32), name='button1', title='Edit', flex='RT')
    B1.background_color = 'lightgray'
    B2 = ui.Button(frame=(154, 202, 80, 32), name='button2', title='Done', flex='LT')
